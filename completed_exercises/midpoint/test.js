...
describe('Midpoint returns the middle node of an odd numbered list', () => {
  test.skip('when the list has 3 elements', () => {
  ...
  test.skip('when the list has 5 elements', () => {
    const l = new LinkedList();
    l.insertLast('a');
    l.insertLast('b');
    l.insertLast('c');
...
describe('Midpoint returns the middle node of an even numbered list', () => {
  test.skip('when the list has 2 elements', () => {
    const l = new LinkedList();
    l.insertLast('a');
    l.insertLast('b');
  ...
  test.skip('when the list has 4 elements', () => {
    const l = new LinkedList();
    l.insertLast('a');
    l.insertLast('b');
    l.insertLast('c');
