...
test.skip('Stack is a class', () => {
  expect(typeof Stack.prototype.constructor).toEqual('function');
});

test.skip('stack can add and remove items', () => {
  const s = new Stack();
  s.push(1);
...
test.skip('stack can follows first in, last out', () => {
  const s = new Stack();
  s.push(1);
  s.push(2);
  s.push(3);
...
test.skip('peek returns the first element but doesnt pop it', () => {
  const s = new Stack();
  s.push(1);
  s.push(2);
  s.push(3);
